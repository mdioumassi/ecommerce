...
class Produit
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity = "CatalogueBundle\Entity\Categorie", inversedBy="produits")
     ...
     * @return Produit
     */
    public function setCategorie(\CatalogueBundle\Entity\Categorie $categorie)
    {
